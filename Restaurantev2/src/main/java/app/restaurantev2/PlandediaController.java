...
public class PlandediaController {
    ...
    public static class PantallaController {
        public static void cambiarPantalla(Stage stageActual, String fxml, String titulo, int ancho, int alto) {
            try {
                FXMLLoader loader = new FXMLLoader(PlandediaController.class.getResource(fxml));
    ...
    public void initialize() {
        if (btnMesas != null) {
            btnMesas.setOnAction(e -> {
                ...
                PantallaController.cambiarPantalla(stageActual, "/app/restaurantev2/LiderMeseros.fxml", "Mesas y Meseros", 1600, 900);
            });
        }
        if (btnPlandedia != null) {
            btnPlandedia.setOnAction(e -> {
                Stage stageActual = (Stage) btnPlandedia.getScene().getWindow();
                PantallaController.cambiarPantalla(stageActual, "/app/restaurantev2/LiderdeMeseros_Plandedia.fxml", "Plan de Día - Líder de Meseros", 1600, 900);
            });
        }
        if (btnSolicitudes != null) {
            btnSolicitudes.setOnAction(e -> {
                Stage stageActual = (Stage) btnSolicitudes.getScene().getWindow();
                PantallaController.cambiarPantalla(stageActual, "/app/restaurantev2/Solicitudes.fxml", "Solicitudes de Meseros", 1600, 900);
            });
        }
        if (btnSalir != null) {
